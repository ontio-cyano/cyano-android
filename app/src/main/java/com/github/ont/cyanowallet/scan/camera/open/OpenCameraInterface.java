...
package com.github.ont.cyanowallet.scan.camera.open;
...
//            LogUtils.LogI(TAG, "Opening camera #" + cameraId);
...
//                LogUtils.LogI(TAG, "No camera facing back; returning camera #0");
